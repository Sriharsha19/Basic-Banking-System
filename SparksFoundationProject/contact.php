...
<body>
    ...
    <class class="welcome">
        <h2>
            <img src="https://img.freepik.com/premium-vector/handshake-icon-logo-design_586739-112.jpg" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>We are here to help you !</strong> <img
                src="https://img.freepik.com/premium-vector/handshake-icon-logo-design_586739-112.jpg" alt="Bank" width="75" height="75">
        </h2>
    </class>
