...
<class class="welcome">
       <center>
         <h2>
            <img src="https://thumbs.dreamstime.com/b/transaction-history-icon-transaction-history-icon-simple-vector-illustration-215661773.jpg" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Transaction History</strong> <img
                src="https://thumbs.dreamstime.com/b/transaction-history-icon-transaction-history-icon-simple-vector-illustration-215661773.jpg" alt="Bank" width="75" height="75">
        </h2>
        <center>
    </class>
